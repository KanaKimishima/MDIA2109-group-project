...
import styles from './SecondAudioPlayer.module.css'
import Previous from "../PreviousButton";
import NextButton from "../NextButton";
export default function SecondAudioPlayer() {
...
return(
    ...
    <audio ref={audioPlayer} src="/audio/NatureAudio.mp3" preload="metadata" ></audio>
